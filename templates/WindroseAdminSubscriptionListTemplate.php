...
use WP_List_Table;
use WindroseSubscription\Includes\WindrosePauseSubscription;
use WindroseSubscription\Includes\WindroseReactivateSubscription;
use WindroseSubscription\Includes\WindroseCancelSubscription;
...
class WindroseAdminSubscriptionListTemplate extends WP_List_Table {
            ...
            switch ($current_action) {
                case 'pause':
                    ...
                    foreach ($selected_ids as $id) {
                        ...
                        $pause_subscription = new WindrosePauseSubscription();
                ...
                case 'activate':
                    foreach ($selected_ids as $id) {
                        $activate_subscription = new WindroseReactivateSubscription();
                ...
                case 'cancel':
                    foreach ($selected_ids as $id) {
                        $cancel_subscription = new WindroseCancelSubscription();
