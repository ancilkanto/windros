...
if ( ! class_exists( 'Windros_Create_Subscription' ) ) {
    class Windros_Create_Subscription {
        public function __construct() {
            ...
            add_action('woocommerce_thankyou', [$this, 'update_subscription_order_user_id'], 10, 1);
        }


        public function initiate_subscription( $order_id, $product_id, $subscription_schedule ) {
        ...
        public function update_subscription_order_user_id($order_id) {
            ...
            $format = array('%s');  // The email is a string
            $where_format = array('%s');  // The ID is an integer
